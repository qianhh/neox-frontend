...
test('base view +@mobile', async({ render, mockApiResponse, mockEnvs }) => {
  ...
  await mockApiResponse('core:arbitrum_l2_messages', depositsMock.baseResponse, { pathParams: { direction: 'to-rollup' } });
  await mockApiResponse('core:arbitrum_l2_messages_count', 3971111, { pathParams: { direction: 'to-rollup' } });
