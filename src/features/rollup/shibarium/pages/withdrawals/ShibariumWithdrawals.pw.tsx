...
import { data as withdrawalsData } from 'src/features/rollup/shibarium/mocks/withdrawals';
...
test('base view +@mobile', async({ render, mockApiResponse, mockEnvs }) => {
  ...
  await mockApiResponse('core:shibarium_withdrawals', withdrawalsData);
  await mockApiResponse('core:shibarium_withdrawals_count', 397);
