...
test('without testnet warning', async({ render, mockEnvs }) => {
  await mockEnvs([
...
test('stability customization', async({ render, mockEnvs, mockAssetResponse }) => {
...
test('with grouped fees', async({ render, mockEnvs }) => {
  await mockEnvs([
